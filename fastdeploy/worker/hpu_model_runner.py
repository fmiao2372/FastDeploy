...
class HPUModelRunner(ModelRunnerBase):
    ...
    def _init_share_inputs(self, max_num_seqs: int):
        ...
        self.share_inputs["ori_seq_lens_encoder"] = paddle.full(
            [max_num_seqs, 1], 0, dtype='int32').cpu()
        ...
        self.share_inputs["block_tables"] = paddle.full(
            [max_num_seqs, pre_max_block_num], -1, dtype='int32').cpu()
    ...
    def initialize_forward_meta(self):
        ...
        self.forward_meta = ForwardMeta_HPU.init_forward_meta(
    ...
    def _dummy_run(self,
        ...
        while True:
            ...
            step_intel_hpu(self.share_inputs, self.cache_config.block_size,
                      self.parallel_config.max_model_len)
    ...
    def warm_up_bucket(self) -> None:
        ...
        for prefill_batch in prefill_batchs:
            for prefill_length in range(self.cache_config.block_size, max_prefill_length, self.cache_config.block_size):
