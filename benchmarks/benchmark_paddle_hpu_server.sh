...
FD_ATTENTION_BACKEND=BLOCK_ATTN python -m fastdeploy.entrypoints.openai.api_server --model /data/disk2/ERNIE-4.5-21B-A3B-Paddle --port 8188 --tensor-parallel-size 1 --max-model-len 32786 --max-num-seqs 128 --block-size 128
