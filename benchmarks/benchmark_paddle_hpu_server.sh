...
# rm -rf log 2>/dev/null
# HPU_WARMUP_BUCKET=1 HPU_WARMUP_MODEL_LEN=4096 FD_ATTENTION_BACKEND=BLOCK_ATTN python -m fastdeploy.entrypoints.openai.api_server --model /data/disk3/ernie_opensource/ERNIE-4.5-300B-A47B-Paddle --port 8188 --tensor-parallel-size 8 --max-model-len 32786 --max-num-seqs 128 --block-size 128
